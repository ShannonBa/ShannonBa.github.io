...
## Analysis of muchroom growht rates
...
This data set was collected to determine the fastest condistions for growing Oyster Mushrooms for a farmers' market.
...
Now, the anlysis! First we want to fit a couple different models:
...
Our first model appears to do a better, and simpler job of explaining growth rate, so we will wtick with that for predictions. 
